...
The inspiration for this project came from the cross polination of two interests I've been wanting to explor for some time. How do audio visualizers work? How do I write code for the GPU.
