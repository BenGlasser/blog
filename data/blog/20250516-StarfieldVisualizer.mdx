...
The idea for this project began with a simple question: _What if a starfield could dance to music?_ I wanted to create something that felt both cosmic and reactive—a visualizer that didn’t just pulse to the beat, but shimmered, rippled, and evolved with the sound.
